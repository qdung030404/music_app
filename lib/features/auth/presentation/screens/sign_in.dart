...
import 'package:music_app/features/auth/presentation/screens/sign_up.dart';
...
import 'package:music_app/features/auth/presentation/screens/forgot_password.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ImageButton(
                    onTap: () async {
                      bool result = await FirebaseAuthService().signInWithGoogle();
                      if (result) {
